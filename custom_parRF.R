...
customparRF <- list(label = "Parallel Random Forest",
                  ...
                  fit = function(x, y, wts, param, lev, last, classProbs, ...) {
                    ...
                    theDots <- list(...)
                    theDots$ntree <- if(is.null(theDots$ntree) & is.null(param$ntree)) 
                      formals(randomForest:::randomForest.default)$ntree 
                                     else if(is.null(param$ntree) & !is.null(theDots$ntree))  theDots$ntree
                                     else param$ntree
                    ...
                    theDots$nodesize <- param$nodesize
